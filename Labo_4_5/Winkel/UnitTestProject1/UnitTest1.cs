...
//
// Als de volledige opdracht van Minerva afgewerkt en via hoofdprogramma getest is,
...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        private DataStorageMetReader dataStorage = new DataStorageMetReader();
        ...
        // test ophalen van alle customers
        // en toevoegen van een customer
        [TestMethod]
        public void testGetCustomersEnAddCustomer()
        {
            ...
            int cNumber = customer.CustomerNumber;
		...
		[TestMethod]
		public void testGetCustomersFromAdapter()
		{
			List<Customer> customersReader = dataStorage.GetCustomers();
			int aantalMetReader = customersReader.Count;

			DataStorageMetDataTable storageMetDataTable = new DataStorageMetDataTable();
			List<Customer> customersAdapter = storageMetDataTable.GetCustomers();
			int aantalMetAdapter = customersAdapter.Count;

			Assert.AreEqual(aantalMetReader, aantalMetAdapter);
		}

		public void testGetTempCustomersFromAdapter()
		{
			List<Customer> customersReader = dataStorage.GetCustomers();
			int aantalMetReader = customersReader.Count;
        ...
        // bovenop de gevraagde methodes in Minerva.
        //[TestMethod]
        //public void testGetOrdersAndAddOrderWithDetails()
        //{
        //    // Deze test zal faliekant aflopen als er geen customers zijn. Soit.
